...
BEGIN
	...
	*/
	...
	INSERT INTO #TablesToSync VALUES 
		('Students'			, 'Snapshot','FreeLunch,Grade',200),
		('Person'			, 'Snapshot',NULL, 100),
		('AttendStatus'		, 'Snapshot',NULL,300),
		('Episode'			, 'Snapshot',NULL,400),
		('Excuse'			, 'Snapshot',NULL,500),
		('FreeReducedLunch'	, 'Snapshot',NULL,600),
		('Outcome'			, 'Snapshot',NULL,700),
		('ReleaseReasons'	, 'Snapshot',NULL,800),
		('PersonDayAttend'	, 'Transactional','DayLateMin',1000),
		('LunchSched'		, 'Snapshot','CUSTOMLunchSched', 900);
