...
where po.SchoolID IN (' + dbo.DataGeneratorGetSchoolIDs(@SchoolID) + ') ' 
	...
	select [PersonID],[SchoolID],[DateHired],[Department],[EmployeeNumber],[Title],0 as PhotoPath,0 as HomeRoom,OfficeLocation FROM ' + @RemoteServerString + 'dbo.StaffBySchool s
